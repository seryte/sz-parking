...
class HTTPParkReservationClient:
    def __init__(
        ...
        self._retry_wait_tm_ms = (
            lambda: float(random.randint(1, 5)) / 10
        )  # 每次重试等待的时间
        ...
        while True:
            try:
                ...
                if retry > 0:
                    ...
                    time.sleep(self._retry_wait_tm_ms())
                    continue
                else:
    ...
    def get_park_detail(self, park_code="100068", debug=False):
        # 100068是深圳湾公园
        ...
        return self._make_request(url, data, headers, debug)
    ...
    def bind_car(self, car_no: str, iphone: str, verification_code: str, debug=False):
        ...
        return self._make_request(url, body, headers, debug)
    ...
    def get_code(self, force=False, debug=False):
        ...
        data = self._make_request(url, body, headers, debug)
        ret = {}
